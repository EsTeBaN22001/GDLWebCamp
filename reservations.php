...
<section class="section container">
  ...
  <form method="POST"action="index.html" id="registration" class="registration">
            ...
            <li>
              <div class="table-price">
                ...
                <div id="order">
                  ...
                  <input class="input-price" type="number" name="pass-day" id="pass-day" min="0" size="3" placeholder="0">
                </div>
              </div>
            </li>
            <li>
              <div class="table-price">
                ...
                <div id="order">
                  ...
                  <input class="input-price" type="number" name="complet-day" id="complet-day" min="0" size="3" placeholder="0">
                </div>
              </div>
            </li>
            <li>
              <div class="table-price">
                ...
                <div id="order">
                  ...
                  <input class="input-price" type="number" name="pass-two-days" id="pass-two-days" min="0" size="3" placeholder="0">
                </div>
              </div>
            </li>
          </ul>
